				 ...
				 $output .= "<div class='container av-logo-container'>";
					...
					$output .= "<div class='inner-container'>";
						...
						*/
                            ...
                            $main_nav .= "<div class='phone-info'>";
                            $main_nav .= "<div class='phone-info-item'><span class='location'>Concord</span> <a class='number header click-to-call' href='tel:925-852-7438'>925-852-7438</a></div>";
                            $main_nav .= "<div class='phone-info-item hide-mobile'><span class='location'>Santa Rosa</span> <a class='number header click-to-call' href='tel:925-852-7438'>707-204-0255</a></div>";
                            $main_nav .= "<div  class='phone-info-item hide-mobile'><span class='location'>San Mateo</span> <a class='number header click-to-call' href='tel:925-852-7438'>650-653-8118</a></div>";
                            $main_nav .= "</div>";
